...
description: House style for writing technical documentation in the manner of Stripe, Google and other best-in-class developer docs. Use this whenever writing or editing a README, API reference, quickstart, tutorial, how-to guide, docstring, CLI help text, changelog entry, or any other developer-facing documentation, even if the user just says "document this" or "add docs" without specifying a style. Also use when reviewing existing documentation for clarity or tone.
---
